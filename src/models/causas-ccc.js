...
// Índices compuestos
CausasCCCSchema.index({ number: 1, year: 1, incidente: 1, fuero: 1 }, { unique: true });
...
CausasCCCSchema.index({ 'scrapingProgress.skipUntil': 1 });

// Método estático para manejar errores E11000 (duplicados)
CausasCCCSchema.statics.safeSave = async function(docData) {
    try {
