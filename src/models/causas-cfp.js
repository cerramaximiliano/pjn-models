...
// Índices compuestos
CausasCFPSchema.index({ number: 1, year: 1, incidente: 1, fuero: 1 }, { unique: true });
...
CausasCFPSchema.index({ 'scrapingProgress.skipUntil': 1 });
...
CausasCFPSchema.add(require("../shared/sentencias-scan-fields"));
CausasCFPSchema.add(require("../shared/etapa-procesal-fields"));
